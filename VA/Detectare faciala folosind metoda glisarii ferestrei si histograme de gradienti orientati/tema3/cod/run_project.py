...
params.overlap = 0.3
# dublu deoarece folosesc si flip
...
if params.use_hard_mining:
    hard_negative_mining = facial_detector.run(return_descriptors = True)
    negative_features = np.append(negative_features, hard_negative_mining, axis = 0)
